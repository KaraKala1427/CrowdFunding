<section id="about" class="testimonials">
    ...
    <div class="container">
        <div class="row text-center text-white">
            <h1 class="display-3 fw-bold">О нас</h1>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="testimonials__card">
                            <p class="lh-lg">
                                CrowdFunding.kz предоставляет платформу для стартапов для привлечение народных инвестиций. Краудфандинг позволяет сделать первый шаг на пути к реализации своей мечты
                            </p>
                        </div>
                    </div>
